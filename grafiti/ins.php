	...
	<div data-role="panel" data-display="push" id="menu" data-theme="b">
       <ul data-role="listview">
	    ...
	    <div data-role="collapsible" data-content-theme="b">
            ...
            <ul data-role="listview">
	            <li data-icon='false'><a href="ques.html"><i class='lIcon fa fa-angle-right'></i>¿Qué es?</a></li>
	            <li data-icon='false'><a href="donde.html"><i class='lIcon fa fa-angle-right'></i>¿Donde puedo verlos?</a></li>
	            <li data-icon='false'><a href="#"><i class='lIcon fa fa-angle-right'></i>Inscribete</a></li>
...
<!-- End Menu -->
     <div data-role="content">   
            ...
            <div class='inset'>
            <h2>¡se parte de este fenómeno!</h2>
            <?php
			error_reporting(0);
            ...
            <input type="hidden" name="flag" value="1">
               <ul data-role="listview" data-inset="true">
                    ...
                    <li data-role="fieldcontain">
                        <label for="textarea2b">¿Porque quieres ser parte?:</label>
                    ...
                    <li><b>Evidencia de tu arte</b></li>
                    <li data-role="fieldcontain">
