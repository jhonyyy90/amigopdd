       ...
       <ul data-role="listview">
	    ...
	    <div data-role="collapsible" data-content-theme="b">
            ...
            <ul data-role="listview">
	            ...
	            <li data-icon='false'><a href="ins.php"><i class='lIcon fa fa-angle-right'></i>Inscribete</a></li>
	            <li data-icon='false'><a href="#"><i class='lIcon fa fa-angle-right'></i>Denuncia</a></li>
            </ul>
        </div>
<ul data-role="listview">
     ...
     <div data-role="content">   
			...
			<div class='message success'>
				<i class='fa fa-check'></i>
                  ...
                  <p>Sú numero de fólio es: <b>GR-1500312</b>, conservelo para darle seguimiento.</p>
				</div>            <?php
				}
			?>
