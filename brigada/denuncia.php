	...
	<div data-role="panel" data-display="push" id="menu" data-theme="b">
       <ul data-role="listview">
	    ...
	    <div data-role="collapsible" data-content-theme="b">
            ...
            <ul data-role="listview">
	            <li data-icon='false'><a href="ques.html"><i class='lIcon fa fa-angle-right'></i>¿Qué es?</a></li>
     ...
     <div data-role="content">   
			...
			<div class='message success'>
				<i class='fa fa-check'></i>
                  ...
                  <p>Sú numero de fólio es: <b>BA-1500312</b>, conservelo para darle seguimiento.</p>
				</div>            <?php
				}
			?>
               ...
               <ul data-role="listview" data-inset="true">
                    ...
                    <li data-role="fieldcontain">
                        <fieldset data-role="controlgroup">
                            <legend>Animal(es) involucrado(s):</legend>
                            <input type="checkbox" name="checkbox-1a" id="checkbox-1ab">
                            <label for="checkbox-1ab">Perros</label>
                            <input type="checkbox" name="checkbox-2a" id="checkbox-2ab">
                            <label for="checkbox-2ab">Gatos</label>
                            <input type="checkbox" name="checkbox-3a" id="checkbox-3ab">
                            <label for="checkbox-3ab">Aves</label>
                            <input type="checkbox" name="checkbox-4a" id="checkbox-4ab">
                            <label for="checkbox-4ab">Exóticos</label>
                            <input type="checkbox" name="checkbox-5a" id="checkbox-5ab">
                            <label for="checkbox-5ab">Otros</label>
                      	</fieldset>
                    </li>                   
                    <li><b>Dirección</b></li>
                  <li data-role="fieldcontain">
       ...
       <form action="seguimiento.php" method="post">
        ...
          <div class='showastabs center nobg'>
			<button type="submit" data-inline='true'><i class='lIcon fa fa-check'></i>Consultar</button>
           	<a href="dialog/index.html" data-rel="back" data-role="button" data-inline="true"><i class='lIcon fa fa-times'></i>Cerrar</a>
